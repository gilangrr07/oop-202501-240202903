...
public class ReportView extends BorderPane {
    ...
    private void initializeUI() {
        ...
        TableColumn<Transaction, ?>[] transCols = new TableColumn[]{codeCol, dateCol, subtotalCol, methodCol, statusCol};
        transactionTable.getColumns().addAll(transCols);
    ...
    private void loadReport() {
        try {
            ...
            @SuppressWarnings("unchecked")
            java.util.List<Transaction> transactions = (java.util.List<Transaction>) report.get("transactions");
