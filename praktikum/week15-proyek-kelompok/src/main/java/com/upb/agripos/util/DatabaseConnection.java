...
public class DatabaseConnection {
    ...
    private static final String URL = "jdbc:postgresql://localhost:5432/agripos"; // Default port 1212
    private static final String USER = "postgres";
    private static final String PASSWORD = "071005"; // Ganti dengan password pgAdmin Anda
